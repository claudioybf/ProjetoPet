...
<html lang="pt">
	...
	<body>
		...
		<div class="container" style="padding-top: 50px;">
			<div class="principal">
				<h1 class="page-header">Alterar Cadastrado</h1>
				<table class="table  table-hover table-striped table-bordered">
					<thead>
						<tr>
							...
							<th>Raça</th>
							<th>Peso(kg)</th>
							<th class="alert-info">Alterar</th>
						</tr>
					</thead>
					<?php
						$banco = new db();
					...
					<tr>
						...
						<td><?=$animal ['raca']?></td>
						<td><?=$animal ['peso']?></td>
						<td class="centralizar"><a href="../view/Formulario-Altera-Animal.php?id=<?=$animal ['id']?>" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span></a></td>
					</tr>
					<?php 
						endforeach
					 ?>
