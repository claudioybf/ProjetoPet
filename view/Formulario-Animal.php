...
<html lang="pt">
	...
	<body>
		...
		<div class="container" style="padding-top: 50px;">
			<div class="principal">
				<h1 class="page-header">Adicione o Animal</h1>
				<div class="row form-produto" >
						<form  class="form-horizontal" name="produto" method="post" action="../controller/Adicionar-Animal.php">
							<div class="form-group">
								<label class="col-sm-1"></label>
							    <label for="inputEmail3" class="col-sm-2 control-label">Nome</label>
							   <div class="col-sm-6">
							      <input type="text" class="form-control" name="nome" id="inputEmail3" autofocus="autofocus" placeholder="Nome do Animal">
							    </div>
							  </div>
							  <div class="form-group">
							  	<label class="col-sm-1"></label>
							    ...
							    <div class="col-sm-6">
							      <input type="text" class="form-control" id="inputPassword3" placeholder="Raça do Animal" name="raca">
							    </div>
							  </div>
							  <div class="form-group">
							  	<label class="col-sm-1"></label>
							    ...
							    <div class="col-sm-6">
							      <input type="text" class="form-control" id="inputPassword3" placeholder="Peso do Animal" name="peso">
							    </div>
							  </div>
							  <div class="form-group">
